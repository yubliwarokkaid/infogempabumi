  ...
  return (
    ...
    >
      <ul className="block lg:flex">
        <li className="group">
          <Link href="/">
            <div className="mx-4 flex py-2 text-sm uppercase tracking-wider text-slate-800 group-hover:text-sky-500">
              Beranda
            </div>
          </Link>
        </li>
        ...
        <li className="group">
          <Link href="#cuaca-terkini">
            <div className="ml-4 flex py-2 text-sm uppercase tracking-wider text-slate-800 group-hover:text-sky-500">
              Cuaca Terkini
            </div>
          </Link>
        </li>
